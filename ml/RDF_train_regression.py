...
model = RandomForestRegressor(max_depth = d_value, random_state = ran_value, n_estimators = n_value)
...
with open(os.path.join(filepath, 'RDF_regression.pickle'), 'wb') as f:
    pickle.dump(model, f)